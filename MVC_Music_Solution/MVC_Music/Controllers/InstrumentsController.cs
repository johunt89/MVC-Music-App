...
namespace MVC_Music.Controllers
{
    ...
    public class InstrumentsController : CustomControllers.ElephantController
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            //if (User.IsInRole("Staff"))  //need to figure out how to determine who entered
            //{
            //    if (instrument. != User.Identity.Name)
            //    {
        ...
        public async Task<IActionResult> Edit(int id, string[] selectedOptions)
        {
            ...
            if (User.IsInRole("Staff"))
            {
                ...
                {
                    ModelState.AddModelError("", "Staff can only edit instruments they entered");
                    ViewData["NoSubmit"] = "disabled=disabled";
                }
            }
            ...
            if (User.IsInRole("Staff"))  //need to figure out how to determine who created record
            {
                if (instrumentToUpdate.CreatedBy != User.Identity.Name)
                {
                    ModelState.AddModelError("", "Staff can only edit instruments they entered");
